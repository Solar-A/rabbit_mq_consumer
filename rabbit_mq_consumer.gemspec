...
require_relative 'lib/rabbit_mq_consumer/version'

Gem::Specification.new do |spec|
  spec.name          = 'rabbit_mq_consumer'
  spec.version       = RabbitMQConsumer::VERSION
  ...
  spec.homepage      = 'https://github.com/Solar-A/rabbit_mq_consumer'
